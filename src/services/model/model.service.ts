import { camelFromKabobOrPascal, lowerize, pascalFromKabobOrCamel } from '@bjanderson/utils';
...
export class ModelService {
  ...
  createJSModel(config: ModelConfig): void {
    const text = `import { getObject, getString } from '@bjanderson/utils';
...
`;
  ...
  createModelSpec(config: ModelConfig): void {
    const text = `import { DEFAULT_STRING } from '@bjanderson/utils';
